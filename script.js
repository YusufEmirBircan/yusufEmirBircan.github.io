...
function getTextPoints(text) {
    ...
    // Ekran genişliğine göre esnek yazı boyutu (responsive) - Mobilde aşırı küçülmemesi için taban eklendi
    let fontSize = Math.min(window.innerWidth * 0.1, 90);
    if (window.innerWidth < 600) fontSize = Math.max(fontSize, 50); // Mobilde min 50px
